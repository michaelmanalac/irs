    ...
    <div class="mdl-cell mdl-cell--8-col">
        <div class="mdl-card mdl-card--width-full mdl-shadow--6dp">
            <div class="mdl-card__supporting-text">
                {!! Form::open(['route' => ['payments.update', $transaction_id, $payment_id], 'method' => 'PATCH']) !!}
                <div class="mdl-grid">
                    <div class="mdl-cell mdl-cell--8-col">
                    ...
                    <div class="mdl-cell mdl-cell--8-col">
                        <div class="mdl-selectfield mdl-js-selectfield">
                            <select id="payment_type" name="payment_type" class="mdl-selectfield__select" required>
                                <option value="{{ $payment_type_id }}">{{ $payment_type_name }}</option>
                ...
                <div class="mdl-grid">
                    <div class="mdl-cell mdl-cell--4-col">
                        <div class="mdl-textfield mdl-js-textfield">
                            <input type="number" maxlength="7" value="{{ $amount }}" class="mdl-textfield__input" placeholder="Amount" name="amount" id="amount" required />
